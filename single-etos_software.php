...
while ( have_posts() ) :
    ...
    $software_classes = array(
        'etos-software-single',
        'etos-software-single--vendor-' . $vendor_slug,
    );
    ...
    if (
        ! in_array(
            $hero_media_style,
            array( 'photo', 'packshot' ),
            true
        )
    ) {
        $hero_media_style = 'photo';
    }
    ...
    <main class="site-main" id="main">
        ...
        <article
            <?php post_class( $software_classes ); ?>
            id="post-<?php the_ID(); ?>"
            style="--etos-software-accent: <?php echo esc_attr( $accent ); ?>;"
        >
            <header
                class="etos-page-hero etos-page-hero--media etos-software-hero"
            >
                ...
                <div class="container etos-container">
                    ...
                    <div class="row g-5 align-items-center">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="etos-page-hero__content">
                                ...
                                <?php if (
                                    ...
                                    || ! empty( $secondary_cta['url'] )
                                    || $partner_logo_id
                                ) : ?>

                                    <div class="etos-software-hero__actions">

                                        <div class="etos-software-hero__buttons">
                                        ...
                                        <?php if ( $partner_logo_id ) : ?>
                                            ...
                                            <div
                                                class="etos-software-hero__partner-logo"
                                            >
                                                ...
                                                echo wp_get_attachment_image(
                                                    ...
                                                    false,
                                                    array(
                                                        'class' => 'etos-software-hero__partner-logo-image',
                                                        'loading' => 'eager',
                                                    )
                                                );
                                                ?>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div
                                class="etos-software-hero__visual etos-software-hero__visual--<?php echo esc_attr(
                                    $hero_media_style
                                ); ?>"
                                style="
                                    --etos-software-image-fit: <?php echo esc_attr(
                                        $hero_image_fit
                                    ); ?>;
                                    --etos-software-image-scale: <?php echo esc_attr(
                                        $hero_image_scale / 100
                                    ); ?>;
                                    --etos-software-image-x: <?php echo esc_attr(
                                        $hero_image_x
                                    ); ?>%;
                                    --etos-software-image-y: <?php echo esc_attr(
                                        $hero_image_y
                                    ); ?>%;
                                "
                            >
                                ...
                                <?php else : ?>
                                    ...
                                    <div
                                        class="etos-software-hero__placeholder"
                                    >
                                        <span>
                                            <?php
                                            echo esc_html(
