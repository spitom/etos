...
$footer_cta = $GLOBALS['etos_footer_cta'] ?? array(
    'eyebrow' => 'Zacznij od krótkiej rozmowy',
    'title'   => 'Dobierzmy rozwiązanie do procesów Twojej firmy.',
    'text'    => 'Opowiedz nam, jak dziś pracujesz i gdzie pojawiają się trudności. Zaproponujemy system, zakres wdrożenia i wsparcie dopasowane do Twoich potrzeb.',
    'button'  => 'Porozmawiaj z doradcą',
	'note'    => 'Wspólnie ustalimy najlepszy kolejny krok.',
    'url'     => '/kontakt/',
);
?>
                    ...
                    <div class="row g-5">
                        ...
                        <div class="col-xl-4 col-lg-5">
                            ...
                            <div class="etos-footer__brand">
                                ...
                                <p>
                                    Autoryzowany partner i integrator systemów ERP.
                                    Wspieramy firmy we wdrażaniu oprogramowania oraz
                                    utrzymaniu stabilnego środowiska IT.
                                </p>
                        ...
                        <div class="col-xl-3 col-lg-3">
                            ...
                            <address class="etos-footer__contact">
                                ...
                                <a href="tel:+48895350808">
                                    +48 89 535 08 08 - sklep, serwis
                                </a>

                                <a href="tel:+48895352309">
                                    +48 89 535 23 09 - wdrożenia
                                </a>

                                <a href="mailto:info@etos.com.pl">
                                    info@etos.com.pl
                                </a>
